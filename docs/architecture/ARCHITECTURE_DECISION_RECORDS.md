...
1. [ADR-001: Next.js 16 with App Router](#adr-001-nextjs-16-with-app-router)
2. [ADR-002: Bun Runtime](#adr-002-bun-runtime)
3. [ADR-003: SQLite to PostgreSQL Migration](#adr-003-sqlite-to-postgresql-migration)
4. [ADR-004: Socket.IO for WebSocket](#adr-004-socketio-for-websocket)
5. [ADR-005: AES-256-GCM for API Keys](#adr-005-aes-256-gcm-for-api-keys)
6. [ADR-006: Zustand for State Management](#adr-006-zustand-for-state-management)
7. [ADR-007: k-NN Lawrence Classifier](#adr-007-k-nn-lawrence-classifier)
